...
// 	  this->LaunchingStatus = JVM_DLL_INSTANCIATED;
// 	  return true;
// 	}
//     } 
//   else 
...
// 	{
// 	  this->LaunchingStatus = JVM_PROCESS_LAUNCHED;
// 	  return true;
// 	}
//     }
...
// jclass SunJVMLauncher::findClass(const std::string& clazz)
// {
//   JNIEnv* env = new JNIEnv();
//   jint result = m_javavm->AttachCurrentThread((void**)&env, 0);
//   DEBUG("Attached thread to the VM: " + StringUtils::toString(result));
...
// jmethodID SunJVMLauncher::findMethod(jclass& cls, const std::string& methodname, const std::string& signature, bool isStatic)
// {
//   JNIEnv* env = new JNIEnv();
//   jint result = m_javavm->AttachCurrentThread((void**)&env, 0);
//   DEBUG("Attached thread to the VM: " + StringUtils::toString(result));
...
//   jmethodID mid;
//   if (isStatic)
//     mid = (jenv)->GetStaticMethodID(cls, methodname.c_str(), signature.c_str());
//   else
//     mid = (jenv)->GetMethodID(cls, methodname.c_str(), signature.c_str());

//   return mid;
// }

// JavaVM* SunJVMLauncher::getJavaVM()
// {
//   return m_javavm;
// }

// void SunJVMLauncher::invokeVoidStatic(jclass clazz, jmethodID& methodid, jvalue arguments[])
// {
//   JNIEnv *env = new JNIEnv();
//   jint result = m_javavm->AttachCurrentThread((void**)&env, 0);
//   DEBUG("Attached thread to the VM: " + StringUtils::toString(result));
...
//   jenv->CallStaticVoidMethodA(clazz, methodid, arguments);
// }

// jint SunJVMLauncher::invokeIntStatic(jclass clazz, jmethodID& methodid, jvalue arguments[])
// {
//   JNIEnv *env = new JNIEnv();
//   jint result = m_javavm->AttachCurrentThread((void**)&env, 0);
//   DEBUG("Attached thread to the VM: " + StringUtils::toString(result));
...
//   return jenv->CallStaticIntMethodA(clazz, methodid, arguments);
// }

// jlong SunJVMLauncher::invokeLongStatic(jclass clazz, jmethodID& methodid, jvalue arguments[])
// {
//   JNIEnv *env = new JNIEnv();
//   jint result = m_javavm->AttachCurrentThread((void**)&env, 0);
//   DEBUG("Attached thread to the VM: " + StringUtils::toString(result));
...
//   return jenv->CallStaticLongMethodA(clazz, methodid, arguments);
// }
