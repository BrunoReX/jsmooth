...
public class SkeletonPropertiesDialog extends Dialog implements Observer {
        ...
        public SkeletonPropertiesDialog(JSmoothPage jsPage, SkeletonModel skelMdl, JSmoothApplication jsApp) {
        ...
        private Control createPropertyControl(Composite wParent, SkeletonProperty prop) {
                ...
                switch (skelMdl.getPropertyType(prop)) {
                        ...
                        case SkeletonModel.TYPE_TEXT_MULTI :
                                ...
                                // The actual text field
                                txt = new Text(grp, SWT.MULTI | SWT.BORDER | SWT.H_SCROLL | SWT.V_SCROLL);
                                layData = new GridData(GridData.FILL_BOTH);
                                txt.setLayoutData(layData);
                                txt.setText(skelMdl.getPropertyValue(prop));
                ...
                while (it.hasNext()) {
                        ...
                        switch (skelMdl.getPropertyType(prop)) {
                                case SkeletonModel.TYPE_TEXT_SINGLE :
                                        ...
                                        jsApp.setPropertyValue(prop.getIdName(), value); // TODO
        ...
        public void update(Observable o, Object arg) {
                // Although update() doesn't make sense in this dialog
                // TODO
        }
